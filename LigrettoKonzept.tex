...
% User settings
% -----------------------------------------------------------------------------
%\myDoctype {Bachelorarbeit}
%\myDivision {}
%\myTitle {Sicherheitsanalyse einer Marktplattform}
%\mySubTitle {Bachelorarbeit 2011}
%\myAuthor {Rolf Koch, Matthias Kaeser, Patrick Pelleschi}
%\myVersion {1.0}
...
% content:
\input{1_Aufgabenstellung} \newpage
\input{2_Spielbeschreibung}  \newpage
\input{3_Problemanalyse} \newpage
\input{4_Loesungsansatz} \newpage
\input{5_Spielalgorithmus} \newpage
\input{6_Datenstrukturen} \newpage
\input{7_Schnittstellen} \newpage
